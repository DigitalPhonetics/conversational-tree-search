...
## - GC
class ChatEngine:
    def __init__(self, user_id: str, socket, data: GraphDataset, nlu: NLU, sysParser, answerParser, logicParser, valueBackend, env = None) -> None:
...
class FAQBaselinePolicy(ChatEngine):
    def __init__(self, user_id: str, socket, data: GraphDataset, state_encoding: StateEncoding, nlu: NLU, sysParser, answerParser, logicParser, valueBackend,
        ...
        super().__init__(user_id, socket, data, nlu, sysParser, answerParser, logicParser, valueBackend)
