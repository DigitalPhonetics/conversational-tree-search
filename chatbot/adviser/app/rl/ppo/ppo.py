...
from chatbot.adviser.app.rl.spaceAdapter import ActionConfig, SpaceAdapter, SpaceAdapterAttentionInput
...
class PPONetwork(nn.Module):
    def __init__(self, adapter: SpaceAdapter,
                       ...
                       attentions: List[SpaceAdapterAttentionInput] = []) -> None:
        super().__init__()
        ...
        self.actor.append(nn.Linear(current_input_dim, adapter.get_action_dim()))
