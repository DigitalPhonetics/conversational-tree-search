...
from config import ActionType, StateConfig
...
class Cache:
    def __init__(self, device: str, data: GraphDataset, state_config: StateConfig, torch_compile: bool) -> None:
        ...
        for state_input_key in text_embedding_keys:
            ...
            if not embedding_cfg._target_ in self.text_embeddings:
                print(f"Loading Embedding {embedding_cfg._target_} ...")
    ...
    @torch.no_grad()
    def _encode(self, state_input_key: State, text_embedding_name: str, cache_key: str, encode_fn: Any, value: Union[str, List[str]]):
